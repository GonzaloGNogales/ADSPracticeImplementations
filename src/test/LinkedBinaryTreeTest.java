...
class LinkedBinaryTreeTest {
    ...
    void isEmpty() {
        ...
        BinaryTree<Integer> t = new ArrayBinaryTree<>();
    ...
    @org.junit.jupiter.api.Test
    void rootExcept() {
        BinaryTree<Integer> t = new ArrayBinaryTree<Integer>();
    ...
    void iterator_EmptyTree() {
        BinaryTree<Character> emptyTree = new ArrayBinaryTree<>();
    ...
    @org.junit.jupiter.api.Test
    void attachLeft() {
        BinaryTree<Character> t = new ArrayBinaryTree<>();
